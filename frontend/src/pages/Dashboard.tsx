...
export default function Dashboard() {
  ...
  const ToolCard = ({ tool }: { tool: any }) => (
    ...
    >
      {/* Hover Overlay */}
      <div className="absolute inset-0 z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 pointer-events-none rounded-lg" />
    ...
    <div className="min-h-screen">
      <div className="container mx-auto py-10 px-4">
        <header className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Developer Toolkit</h1>
