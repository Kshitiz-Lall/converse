...
const LLMTools: LLMTool[] = [
  ...
  {
    id: 'llm-data-analyzer',
    title: 'Data Analyzer',
    description: 'Explore, clean and prepare your datasets for LLM training',
    icon: <Database />,
    path: '/llm-suites/llm-data-analyzer',
    available: false,
  ...
  },
  {
    ...
    title: 'Inference API',
    description: 'Test and benchmark inference endpoints for deployed language models',
    icon: <Server />,
    path: '/llm-suites/llm-inference-api',
    available: false,
